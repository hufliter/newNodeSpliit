...
--
-- Host: localhost
-- Generation Time: Mar 11, 2016 at 07:32 PM
...
('2iudS9NnsAOk9PyO8WyFixXzaZsfDHHInRDS1ndgZn3QTSrrp3E40SKNJBiiTUsI', 134, 1209600, '2016-03-11 09:29:54');
...
(63, 0, '2016-03-10 00:00:00', 30, 'string', 'string', 0, 'string', '2016-03-10', '2016-03-15', 0, 'string', 'string', 0, 0, 'string', 'string', 1, 3, '2016-03-10 00:00:00', 0, 'string', 0, '\0\0\0\0\0\0\0³´Ss¹™%@\njøÖ«Z@'),
...
(1, 57, 30, 0, 0, 0, 0, 'INCOMPLETE', '2016-03-10 10:50:07', 1, '2016-03-10 10:50:07'),
(2, 65, 30, 0, 0, 0, 0, 'INCOMPLETE', '2016-03-11 00:00:00', 1, '2016-03-11 00:00:00'),
(3, 65, 81, 0, 0, 0, 0, 'INCOMPLETE', '2016-03-11 00:00:00', 1, '2016-03-11 00:00:00');
...
--
ALTER TABLE `deal_group`
  MODIFY `id_deal_group` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `shared_deal`
  MODIFY `id_s_deal` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
