...
--
-- Host: localhost
-- Generation Time: Mar 18, 2016 at 06:51 PM
...
(57, 0, '2016-02-25 12:13:07', 30, '', 'test', 0, '10', '0000-00-00', '2016-03-20', 0, '37 Phan X√≠ch Long, ph??ng 2, Ph√∫ Nhu?n, H? Ch√≠ Minh, Vi?t Nam', '10.800243,106.684942', 10.800243, 106.684942, 'test', '', 1, 2, '2016-02-25 00:00:00', 30, 'http://spliit.local/rest-prod/img/deals/_pictures_20160225121254.jpg', 0, NULL),
(63, 0, '2016-03-10 00:00:00', 30, 'string', 'string', 0, 'string', '2016-03-10', '2016-03-16', 0, 'string', 'string', 0, 0, 'string', 'string', 1, 3, '2016-03-10 00:00:00', 0, 'string', 0, '\0\0\0\0\0\0\0≥¥Ssπô%@\nj¯÷´Z@'),
(65, 0, '2016-03-11 00:00:00', 30, 'string', 'string', 0, 'string', '2016-03-11', '2016-03-19', 0, 'string', 'string', 0, 0, 'string', 'string', 1, 3, '2016-03-11 00:00:00', 0, 'string', 0, '\0\0\0\0\0\0\0A‘}\0Rõ@Sy;¬ikZ@'),
(66, 0, '2016-03-17 00:00:00', 30, 'Test', 'test', 0, '15', '2016-03-17', '2016-03-20', 0, 'string', 'string', 0, 0, 'string', 'string', 1, 3, '2016-03-17 00:00:00', 0, 'string', 0, '\0\0\0\0\0\0\0\'1¨⁄@üÕ™œ’ˆY@'),
(67, 0, '2016-03-17 00:00:00', 134, 'Test', 'Test', 0, 'string', '2016-03-17', '2016-03-27', 1, 'string', 'string', 0, 0, 'Abc', 'Test', 1, 3, '2016-03-17 00:00:00', 0, 'string', 0, '\0\0\0\0\0\0\0˚?á˘Ú	@õ©èƒ	Z@');
...
(9, 'category', 'fr', 'category5', 'Activit√©es'),
...
(23, 'category', 'fr', 'category9', 'Bien √™tre'),
...
(21, '22 Avenue des champs Elys√©es', 'Paris', '75008', 'Y-3', 48.8697, 2.30699, 11),
...
(27, '22 Rue du D√©part', 'Paris', '75015', 'Centre Commercial Montparnasse - Lacoste', 48.8428, 2.32045, 17),
(28, '22 Rue du D√©part', 'Paris', '75015', 'Centre Commercial Montparnasse - Passing Levis', 48.8428, 2.32045, 18),
...
--
ALTER TABLE `deal_group`
  MODIFY `id_deal_group` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `users`
  MODIFY `id_cust` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'Id of customer', AUTO_INCREMENT=135;
--
